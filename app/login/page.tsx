    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-accent-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-slate-900 mt-6 mb-2">Welcome Back</h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-primary-600 to-accent-600 text-white py-3 rounded-lg hover:from-primary-700 hover:to-accent-700 font-semibold flex items-center justify-center space-x-2 transition-all"
            >
              <span>Sign In</span>
              <ArrowRight size={20} />
            </button>
        ...
        <p className="mt-6 text-center text-sm text-slate-500">
          ...
          <Link href="#" className="text-primary-600 hover:text-primary-700">Terms</Link>
          {' '}and{' '}
