...
export default function SignupPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br bg-brand-50 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        {/* Logo */}
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center space-x-2">
            <div className="w-12 h-12 bg-gradient-to-br bg-brand-500 rounded-xl flex items-center justify-center">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <form className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r bg-brand-600 text-white py-3 rounded-lg hover:from-primary-700 hover:to-brand-700 font-semibold flex items-center justify-center space-x-2 transition-all"
            >
