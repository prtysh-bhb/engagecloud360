  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-gradient-to-br bg-brand-500 rounded-lg flex items-center justify-center">
          ...
          {plans.map((plan, index) => (
            <div
              ...
              className={`rounded-2xl ${
                plan.highlighted
                  ? 'bg-gradient-to-br bg-brand-600 text-white shadow-2xl scale-105'
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="bg-gradient-to-r bg-brand-600 rounded-2xl shadow-xl p-12 text-center text-white">
