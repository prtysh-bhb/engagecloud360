                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center space-x-2 mb-2">
                      {post.platforms.map((platform, i) => (
                        <span key={i} className="px-2 py-1 bg-accent-100 text-accent-700 rounded text-xs font-medium">
                          {platform}
                        </span>
                      ))}
                    </div>
            ...
            {recentPosts.map((post, i) => (
              <div key={i} className="p-6">
                <div className="flex items-center justify-between mb-2">
                  <span className="px-2 py-1 bg-accent-100 text-accent-700 rounded text-sm font-medium">
                    {post.platform}
                  </span>
